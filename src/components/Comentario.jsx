...
export default function Comentario() {
  ...
  useEffect(() => {
    const salvas = JSON.parse(localStorage.getItem("avaliacoes")) || [];
    setAvaliacoesReais(salvas);
  }, []);
    ...
    <div className="tela-overlay-premium">
      ...
      <nav className="navegacao-blur">
        <div className="nav-wrapper-premium">
          ...
          <h1 className="titulo-premium-gradiente">
            Reviews do Imóvel
          </h1>
        </div>
      </nav>
      ...
      <div className="container-master">
        ...
        <section className="card-estatisticas-glass">
          <div className="header-nota-impacto">
            ...
            <p className="subtexto-verificado">
              ...
              baseado em {avaliacoesReais.length || 23} avaliações
            </p>
          </div>
        ...
        <div className="feed-comentarios-animado">
          {avaliacoesReais.length > 0 ? (
            avaliacoesReais.map((item, i) => (
              <CardFeedbackPremium
                key={item.id}
                nome={item.nome}
                data={item.data}
        ...
        <div className="info-post-meta">
          ...
          <div className="estrelas-pequenas-gold">
            {[...Array(5)].map((_, i) => (
              <i
                key={i}
                className={`${i < nota ? "fas" : "far"} fa-star`}
              ></i>
            ))}
